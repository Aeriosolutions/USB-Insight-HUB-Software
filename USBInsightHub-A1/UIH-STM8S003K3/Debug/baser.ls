 ...
 298                     ; 88 }
 301  013e 81            	ret
 333                     ; 90 void Update_GPIO_from_I2CRegisters(void){
 334                     	switch	.text
 335  013f               _Update_GPIO_from_I2CRegisters:
 339                     ; 95 	if(r20_CH1REG & ILIMH_MASK)GPIO_WriteLow(CH1_ILIM_H); 
 ...
 353  0150               L13:
 354                     ; 96 	else GPIO_WriteHigh(CH1_ILIM_H); //Active Low
 356  0150 4b80          	push	#128
 357  0152 ae500a        	ldw	x,#20490
 358  0155 cd0000        	call	_GPIO_WriteHigh
 360  0158 84            	pop	a
 361  0159               L33:
 362                     ; 97 	if(r20_CH1REG & ILIML_MASK)GPIO_WriteLow(CH1_ILIM_L); 
 ...
 376  016a               L53:
 377                     ; 98 	else GPIO_WriteHigh(CH1_ILIM_L); //Active Low  				
 379  016a 4b40          	push	#64
 380  016c ae500a        	ldw	x,#20490
 381  016f cd0000        	call	_GPIO_WriteHigh
 383  0172 84            	pop	a
 384  0173               L73:
 385                     ; 99 	if(r20_CH1REG & PWREN_MASK)GPIO_WriteHigh(CH1_PWR_EN); 
 ...
 399  0184               L14:
 400                     ; 100 	else GPIO_WriteLow(CH1_PWR_EN); //Active High
 402  0184 4b20          	push	#32
 403  0186 ae500a        	ldw	x,#20490
 404  0189 cd0000        	call	_GPIO_WriteLow
 406  018c 84            	pop	a
 407  018d               L34:
 408                     ; 101 	if(r20_CH1REG & DATAEN_MASK)GPIO_WriteLow(CH1_DATA_EN); 
 ...
 422  019e               L54:
 423                     ; 102 	else GPIO_WriteHigh(CH1_DATA_EN); //Active Low
 425  019e 4b04          	push	#4
 426  01a0 ae500a        	ldw	x,#20490
 427  01a3 cd0000        	call	_GPIO_WriteHigh
 429  01a6 84            	pop	a
 430  01a7               L74:
 431                     ; 103 	if(GPIO_ReadInputPin(CH1_FAULT))r20_CH1REG &= 0x7F; 
 ...
 445  01ba               L15:
 446                     ; 104 	else r20_CH1REG |= 0x80; 
 448  01ba 721e0000      	bset	_r20_CH1REG,#7
 449  01be               L35:
 450                     ; 106 	if(r21_CH2REG & ILIMH_MASK)GPIO_WriteLow(CH2_ILIM_H); 
 ...
 464  01cf               L55:
 465                     ; 107 	else GPIO_WriteHigh(CH2_ILIM_H);
 467  01cf 4b10          	push	#16
 468  01d1 ae500f        	ldw	x,#20495
 469  01d4 cd0000        	call	_GPIO_WriteHigh
 471  01d7 84            	pop	a
 472  01d8               L75:
 473                     ; 108 	if(r21_CH2REG & ILIML_MASK)GPIO_WriteLow(CH2_ILIM_L); 
 ...
 487  01e9               L16:
 488                     ; 109 	else GPIO_WriteHigh(CH2_ILIM_L);  				
 490  01e9 4b08          	push	#8
 491  01eb ae500f        	ldw	x,#20495
 492  01ee cd0000        	call	_GPIO_WriteHigh
 494  01f1 84            	pop	a
 495  01f2               L36:
 496                     ; 110 	if(r21_CH2REG & PWREN_MASK)GPIO_WriteHigh(CH2_PWR_EN); 
 ...
 510  0203               L56:
 511                     ; 111 	else GPIO_WriteLow(CH2_PWR_EN);
 513  0203 4b04          	push	#4
 514  0205 ae500f        	ldw	x,#20495
 515  0208 cd0000        	call	_GPIO_WriteLow
 517  020b 84            	pop	a
 518  020c               L76:
 519                     ; 112 	if(r21_CH2REG & DATAEN_MASK)GPIO_WriteLow(CH2_DATA_EN); 
 ...
 533  021d               L17:
 534                     ; 113 	else GPIO_WriteHigh(CH2_DATA_EN);
 536  021d 4b08          	push	#8
 537  021f ae500a        	ldw	x,#20490
 538  0222 cd0000        	call	_GPIO_WriteHigh
 540  0225 84            	pop	a
 541  0226               L37:
 542                     ; 114 	if(GPIO_ReadInputPin(CH2_FAULT))r21_CH2REG &= 0x7F; 
 ...
 556  0239               L57:
 557                     ; 115 	else r21_CH2REG |= 0x80; 		
 559  0239 721e0000      	bset	_r21_CH2REG,#7
 560  023d               L77:
 561                     ; 117 	if(r22_CH3REG & ILIMH_MASK)GPIO_WriteLow(CH3_ILIM_H); 
 ...
 575  024e               L101:
 576                     ; 118 	else GPIO_WriteHigh(CH3_ILIM_H);
 578  024e 4b08          	push	#8
 579  0250 ae5000        	ldw	x,#20480
 580  0253 cd0000        	call	_GPIO_WriteHigh
 582  0256 84            	pop	a
 583  0257               L301:
 584                     ; 119 	if(r22_CH3REG & ILIML_MASK)GPIO_WriteLow(CH3_ILIM_L); 
 ...
 598  0268               L501:
 599                     ; 120 	else GPIO_WriteHigh(CH3_ILIM_L);  				
 601  0268 4b04          	push	#4
 602  026a ae5000        	ldw	x,#20480
 603  026d cd0000        	call	_GPIO_WriteHigh
 605  0270 84            	pop	a
 606  0271               L701:
 607                     ; 121 	if(r22_CH3REG & PWREN_MASK)GPIO_WriteHigh(CH3_PWR_EN); 
 ...
 621  0282               L111:
 622                     ; 122 	else GPIO_WriteLow(CH3_PWR_EN);
 624  0282 4b02          	push	#2
 625  0284 ae5000        	ldw	x,#20480
 626  0287 cd0000        	call	_GPIO_WriteLow
 628  028a 84            	pop	a
 629  028b               L311:
 630                     ; 123 	if(r22_CH3REG & DATAEN_MASK)GPIO_WriteLow(CH3_DATA_EN); 
 ...
 644  029c               L511:
 645                     ; 124 	else GPIO_WriteHigh(CH3_DATA_EN);		
 647  029c 4b10          	push	#16
 648  029e ae500a        	ldw	x,#20490
 649  02a1 cd0000        	call	_GPIO_WriteHigh
 651  02a4 84            	pop	a
 652  02a5               L711:
 653                     ; 125 	if(GPIO_ReadInputPin(CH3_FAULT))r22_CH3REG &= 0x7F; 
 ...
 667  02b8               L121:
 668                     ; 126 	else r22_CH3REG |= 0x80; 
 670  02b8 721e0000      	bset	_r22_CH3REG,#7
 671  02bc               L321:
 672                     ; 129 	if(GPIO_ReadInputPin(VHOST_PRESENT))r24_AUXREG 	|= 0x01; 
 ...
 686  02cf               L521:
 687                     ; 130 	else r24_AUXREG &= 0xFE;  
 689  02cf 72110000      	bres	_r24_AUXREG,#0
 690  02d3               L721:
 691                     ; 131 	if(GPIO_ReadInputPin(VEXT_PRESENT))r24_AUXREG 	|= 0x02; 
 ...
 705  02e6               L131:
 706                     ; 132 	else r24_AUXREG &= 0xFD;
 708  02e6 72130000      	bres	_r24_AUXREG,#1
 709  02ea               L331:
 710                     ; 134 	if(GPIO_ReadInputPin(USB3_MUX_OE))r24_AUXREG 		|= 0x04; 
 ...
 724  02fd               L531:
 725                     ; 135 	else r24_AUXREG &= 0xFB;	
 727  02fd 72150000      	bres	_r24_AUXREG,#2
 728  0301               L731:
 729                     ; 137 	if(GPIO_ReadInputPin(USB3_MUX_SEL))r24_AUXREG 	|= 0x08; 
 ...
 997  03b4               L322:
 998                     ; 178 		else if (ccActive >= _1A5L && ccActive <= _1A5H)ccsumtemp &= 0xFE;
...
1015  03ca               L722:
1016                     ; 179 		else if (ccActive >= _3A0L && ccActive <= _3A0H)ccsumtemp &= 0xFF;
...
1033  03e0               L332:
1034                     ; 180 		else ccsumtemp &= 0xFC;		
1036  03e0 7b07          	ld	a,(OFST-2,sp)
1037  03e2 a4fc          	and	a,#252
1038  03e4 6b07          	ld	(OFST-2,sp),a
1040  03e6               L512:
1041                     ; 183 	if(ADC_Host_CC1 <= NOPULLH && ADC_Host_CC2 <= NOPULLH) ccsumtemp &=0x0F;
...
1107  042e               L742:
1108                     ; 196 		else if (ccActive >= _1A5L && ccActive <= _1A5H)ccsumtemp &= 0xEF;
...
1125  0444               L352:
1126                     ; 197 		else if (ccActive >= _3A0L && ccActive <= _3A0H)ccsumtemp &= 0xFF;
...
1143  045a               L752:
1144                     ; 198 		else ccsumtemp &= 0xCF;		
1146  045a 7b07          	ld	a,(OFST-2,sp)
1147  045c a4cf          	and	a,#207
1148  045e 6b07          	ld	(OFST-2,sp),a
1150  0460               L142:
1151                     ; 201 	r23_CCSUM=ccsumtemp;
1153  0460 7b07          	ld	a,(OFST-2,sp)
1154  0462 b700          	ld	_r23_CCSUM,a
1155                     ; 203 }
1158  0464 5b09          	addw	sp,#9
1159  0466 81            	ret
1293                     ; 206 unsigned int ADC_Read(ADC1_Channel_TypeDef ADC_Channel_Number){
1294                     	switch	.text
1295  0467               _ADC_Read:
1297  0467 88            	push	a
1298  0468 89            	pushw	x
1299       00000002      OFST:	set	2
1302                     ; 207    unsigned int result = 0;
1304                     ; 208 	 ADC1_DeInit();
1306  0469 cd0000        	call	_ADC1_DeInit
1308                     ; 209 	 ADC1_Init(ADC1_CONVERSIONMODE_CONTINUOUS, 
1308                     ; 210 							 ADC_Channel_Number, 
1308                     ; 211 							 ADC1_PRESSEL_FCPU_D18, 
1308                     ; 212 							 ADC1_EXTTRIG_TIM, 
1308                     ; 213 							 DISABLE, 
1308                     ; 214 							 ADC1_ALIGN_RIGHT, 
1308                     ; 215 							 ADC1_SCHMITTTRIG_ALL, 
1308                     ; 216 							 DISABLE);
