...
#define PC_CONNECTION_TIMEOUT        2000 
...
void setup() {
  ...
  //Interrupt handler task initialization
...
void loop() {
  ...
  if (once) {
    updateChannelEnumerator(Channel_2, "COM10");
    updateChannelVoltage(Channel_2, 3.3);
    updateChannelCurrent(Channel_2, 0.500);
